...
<head>
	<!--
		USO: http://intranet-se01/dvpi/ged/TB_Form5.php?Tabela=Docum&Titulo=Tititit
		...
		fetch(tabela, myHeaders)
			...
			.then(function (result) {
				...
				for(i=0;i<flds.length;i++){
					...
					if( nomestru == "LinkDoc" ){
						html += "<input type=button onclick=\"var w = window.open('PDFs/reportFiles.php','newPage','width=600,height=400,top=80,left=500');\" value=\"ESCOLHE\">";
						}
					html += "</td></tr>";
					}
